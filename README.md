# 🎓 Smart Vision Facial Attendance Portal  
...
## 📌 Overview
**Smart Vision** is a comprehensive web-based attendance management system that utilizes advanced **facial recognition technology** to automate student attendance tracking.  
...
📁 Project Structure
```
Smart Vision Facial Attendance/
